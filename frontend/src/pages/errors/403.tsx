  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ background: "white", borderRadius: "16px", padding: "40px", width: "100%", maxWidth: "420px", boxShadow: "0 4px 20px rgba(0,0,0,0.08)", textAlign: "center" }}>
        <h1 style={{ fontSize: "64px", fontWeight: "900", color: "#f97316", margin: "0 0 16px" }}>403</h1>
        <h2 style={{ fontSize: "24px", fontWeight: "800", color: "#0f172a", margin: "0 0 8px" }}>Acceso denegado</h2>
        <p style={{ color: "#64748b", fontSize: "15px", marginBottom: "32px", lineHeight: "1.6" }}>
          No tienes permisos para ver este contenido o realizar esta acción.
        </p>
        <button
